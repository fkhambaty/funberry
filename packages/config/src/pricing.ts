export const pricing = {
  ...
  premiumMonthly: {
    ...
    stripeProductId: "prod_funberry_monthly",
    stripePriceId: "price_funberry_monthly",
    revenueCatProductId: "funberry_premium_monthly",
    features: [
  ...
  premiumYearly: {
    ...
    stripeProductId: "prod_funberry_yearly",
    stripePriceId: "price_funberry_yearly",
    revenueCatProductId: "funberry_premium_yearly",
    features: [
      "All 15 Learning Zones",
      "All Games Unlocked",
      "Detailed Progress Reports",
